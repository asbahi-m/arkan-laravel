...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{ __('admin.features') }}</h4>
            <a href="{{ route('feature.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($features as $key => $feature)
                            <tr>
                                ...
                                <td><small>{{ Carbon::create($feature->created_at)->locale(app()->getLocale())->isoFormat('ll') }}</small></td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <button class="btn btn-danger shadow btn-xs sharp mr-1" onclick="confirmDelete({{ $feature->id }})">
            ...
            <div class="py-2">{{ trans_choice('admin.pagination_info', $features->total(), ['items' => $features->count(), 'total' => $features->total()]) }}</div>
