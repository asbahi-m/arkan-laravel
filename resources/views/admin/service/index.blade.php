                    ...
                    <tbody>
                        @foreach ($services as $key => $service)
                            <tr>
                                ...
                                <td><small>{{ Carbon::create($service->created_at)->locale(app()->getLocale())->isoFormat('ll') }}</small></td>
                                <td>
                                    <small class="d-flex align-items-center">
                                        <i class="fa fa-circle text-{{ $service->is_published == 'published' ? 'success' : 'dark' }} mr-1"></i>
                                        <span>{{ __('admin.' . $service->is_published) }}</span>
                                    </small>
                                </td>
                                <td><small>{{ $service->views_count }}</small></td>
                                <td>
                                    <div class="d-flex">
