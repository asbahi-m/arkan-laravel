...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($projects as $key => $project)
                            <tr>
                                ...
                                <td><small>{{ $project->type ? Str::upper($project->type->name) : '' }}</small></td>
                                ...
                                <td><small>{{ Carbon::create($project->created_at)->locale('en')->isoFormat('ll') }}</small></td>
                                <td>
            ...
            <div class="py-2">Showing {{ $projects->count() }} of {{ $projects->total() }} results</div>
            <div>{{ $projects->links() }}</div>
        </div>
    </div>
    <form methods="GET" action="{{ route('project.delete') }}" id="form-delete" class="d-none">
        @method('DELETE')
