...
@section('content')
    <div class="page-titles d-flex">
        <ul class="breadcrumb ml-auto">
            ...
            <li class="breadcrumb-item"><a href="{{ route('projects.all') }}">{{ __('admin.projects_all') }}</a></li>
        </ul>
    </div>

    <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{ __('admin.project_edit') }}</h4>
        </div>
        <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control default-select" name="type">
                            ...
                            @foreach ($types as $type)
                                <option {{ $project['type_id'] == $type['id'] ? 'selected' : '' }}
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox mb-3">
                            ...
                            <input type="checkbox" class="custom-control-input" id="publish" name="is_published"
                                    value="1" {{ $project->is_published ? 'checked' : '' }}>
